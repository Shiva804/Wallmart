...
import "../styles/retailerDetails.css";
import formImg from "../images/photo-1554629947-334ff61d85dc.jpg";
import axios from "../config";

export default class RetailerDetails extends Component {
  constructor() {
    super();
  ...
  submit = async () => {
    ...
    reader.onload = (e) => {
      ...
      this.setState({ source: dataUrl }, async () => {
        data = {
          ...
          file: this.state.source,
        };

        const postData = await axios.post("/retailerDetails", data);
        ...
        <div className="sidebyside">
          ...
          <div className="signup-form-2">
            ...
            <div className="form-input">
              ...
              <br />
              <label for="file">
                Upload Shop Liscence <span style={{ color: "red" }}>*</span>
              </label>
              <br />
              <input
                type="file"
